        ...
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-4">
            ...
            <a
              ...
              className="mt-6 inline-flex h-10 w-10 items-center justify-center rounded-full border border-sand/30 text-sand transition-colors hover:border-rust hover:bg-rust hover:text-white"
            >
              <svg
                viewBox="0 0 24 24"
                className="h-5 w-5"
